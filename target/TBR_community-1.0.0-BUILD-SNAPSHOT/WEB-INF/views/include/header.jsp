...
<html>
 <style>
 	...
 	.sidebar-mini{
 		background:url("${pageContext.request.contextPath}/resources/dist/img/background.jpg");
  ...
  <body class="skin-blue sidebar-mini">
  	<div class="title">
  		<img src="${pageContext.request.contextPath}/resources/dist/img/title_name.png" class="Thumbnail" alt="User Image" id="title_img"/>
  	</div>
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="${pageContext.request.contextPath}/sboard/weekbest">
                <i class="fa fa-folder"></i> <span>금주의 베스트</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span>베스트 목록</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="${pageContext.request.contextPath}/sboard/listbest?kindboard=lcbest"><i class="fa fa-angle-left pull-right"></i>듣기 베스트 목록</a></li>                
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="${pageContext.request.contextPath}/sboard/listPage?kindboard=voca"><i class="fa fa-angle-right pull-left"></i>어휘 게시판</a></li>
                <li><a href="${pageContext.request.contextPath}/sboard/listPage?kindboard=lc"><i class="fa fa-angle-right pull-left"></i>듣기 게시판</a></li>
                <!-- <li>
